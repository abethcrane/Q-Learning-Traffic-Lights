...
public class CarImpl implements Car
{
    ...
    {
        boolean stop = (m.nextNonCarSquareIsTrafficLight(position, direction, l) && ((direction.getXSpeed() !=0 ) == l.horizontalGreen()));        velocity.setXSpeed(stop ? 0 : direction.getXSpeed());
